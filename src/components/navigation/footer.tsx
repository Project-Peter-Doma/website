                ...
                <AnimationContainer delay={0.1}>
                    <div className="flex flex-col items-start justify-start md:max-w-[200px]">
                        ...
                        <p className="text-muted-foreground mt-4 text-sm text-start">
                            Intelligence Layer for DomainFi.
                        </p>
                    </div>
                </AnimationContainer>
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <AnimationContainer delay={0.3}>
                            <div className="mt-10 md:mt-0 flex flex-col">
                                ...
                                <ul className="mt-4 text-sm text-muted-foreground">
                                    <li className="">
                                        <a href="https://x.com/DomainApe" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-all duration-300">
                                            Twitter
                                        </a>
                                    </li>
                                    <li className="mt-2">
                                        <a href="https://github.com/DomainApe" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-all duration-300">
                                            GitHub
                                        </a>
                                    </li>
                                </ul>
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
                <AnimationContainer delay={0.6}>
                    <p className="text-sm text-muted-foreground mt-8 md:mt-0">
                        &copy; 2025 Peter Labs Inc. All rights reserved.
                    </p>
                </AnimationContainer>
            </div>

            <div className="h-[20rem] lg:h-[20rem] hidden md:flex items-center justify-center">
                <TextHoverEffect text="PETER" />
            </div>
        </footer>
    )
}
